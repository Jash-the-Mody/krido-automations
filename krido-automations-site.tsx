                ...
                >
                  {testimonial.type === 'video' ? (
                    ...
                    <div className="p-8 bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl">
                      <div className="w-full max-w-2xl mx-auto aspect-video bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl mb-6 flex items-center justify-center border border-white/20">
                        <div className="text-center">
                          <div className="w-20 h-20 mx-auto mb-4 bg-white/10 rounded-full flex items-center justify-center">
                            <div className="w-0 h-0 border-t-8 border-t-transparent border-l-12 border-l-white border-b-8 border-b-transparent ml-1"></div>
                          </div>
                          <p className="text-gray-400 text-sm">Video Testimonial Placeholder</p>
                          <p className="text-gray-500 text-xs mt-2">Replace with actual video embed</p>
                        </div>
                      </div>
                      <div className="text-center">
